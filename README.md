# EWYL Priority Cases Analysis

## Overview

This script automates the process of fetching EWYL sales report files from Google Drive, extracting data from Google Sheets, and updating a priority cases sheet with analyzed data. It performs the following tasks:
...
- **Process**:
  ...
  2. Extracts all records from the 'EWYL' sheet.
  3. Converts the records to a pandas DataFrame.
